...
//sending Account holder Balance data to Balance.txt
            ...
            System.out.println("Similar Account number exists....");
            return false;
        }
        return false;
    }

    public boolean makeDeposit(String AccountNo, int Amount) {
        int lineNumber;
    ...
    public boolean makeWithdrawal(String AccountNo, String Pin, int WithdrawAmount) {
        int lineNumber;
        lineNumber = ReturnCountOfMatchingLine("AcNo.txt", AccountNo);
        if (ReturnBoleanOfMatchingString("AcNo.txt", AccountNo) == true) {
    ...
    public boolean printStatement(String AcNo) {
        int lineNumber;
    ...
    public boolean transferAmount(String FromAcNo, String ToAcNo, String Pin, int TransferAmount) {
    ...
    public boolean calculateZakat(String AcNo) {
        int lineNumber;
        if (ReturnBoleanOfMatchingString("AcNo.txt", AcNo) == true) {
            lineNumber = ReturnCountOfMatchingLine("AcNo.txt", AcNo);
    ...
    public boolean displayAllDeductions(String AcNo) {
        int lineNumber;
        if (ReturnBoleanOfMatchingString("AcNo.txt", AcNo) == true) {
            lineNumber = ReturnCountOfMatchingLine("AcNo.txt", AcNo);
            String AmountInAccount = ReturnStringOfMatchingCount("Balance.txt", lineNumber);
    ...
    public boolean Interset(String AcNo) {
        int lineNumber;
        if (ReturnBoleanOfMatchingString("AcNo.txt", AcNo) == true) {
            lineNumber = ReturnCountOfMatchingLine("AcNo.txt", AcNo);
            String AmountInAccount = ReturnStringOfMatchingCount("Balance.txt", lineNumber);
    ...
    public boolean DeleteAccount(String AcNo, String CNIC, String Pin) {
        int lineNumber;
        lineNumber = ReturnCountOfMatchingLine("AcNo.txt", AcNo);
